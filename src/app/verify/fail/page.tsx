      ...
      <main className="max-w-2xl mx-auto mt-16">
        ...
        <div className="relative p-8 border-4 border-black bg-white min-h-[400px] flex flex-col">
          ...
          <div className="space-y-8 flex-1 flex flex-col">
            <h2 className="font-mono text-2xl font-bold">Oh no!</h2>

            {/* Center button vertically */}
            <div className="flex-1 flex items-center justify-center">
              Looks like we couldn’t verify you as human. Don’t worry, it
              happens! Try again to get things sorted.
            </div>

            <div className="flex justify-center">
              <Button
                variant="secondary"
                className="bg-zinc-800 text-white hover:bg-zinc-700 w-40"
              >
                Try again
              </Button>
            </div>
